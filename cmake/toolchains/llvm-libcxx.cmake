...
if(WFCLI_SCCACHE)
  set(CMAKE_C_COMPILER_LAUNCHER "${WFCLI_SCCACHE}" CACHE FILEPATH "" FORCE)
  set(CMAKE_CXX_COMPILER_LAUNCHER "${WFCLI_SCCACHE}" CACHE FILEPATH "" FORCE)
endif()
